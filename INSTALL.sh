...
"${DIR}/configure" --prefix=/usr --mandir=/usr/share/man --sysconfdir=/etc --localstatedir=/var --enable-deprecated --disable-cups --disable-a2dp --disable-avrcp --disable-network --disable-hid --disable-hog
